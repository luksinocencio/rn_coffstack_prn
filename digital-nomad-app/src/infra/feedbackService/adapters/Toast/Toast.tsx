...
import { ThemeColors } from '@/ui/theme/theme'
import RNToast, { ToastConfig } from 'react-native-toast-message'
import { Feedback, FeedbackType } from '../../IFeedbackService'

const toastColors: Record<FeedbackType, { backgroundColor: ThemeColors; textColor: ThemeColors }> = {
  error: {
...
export function Toast() {
  return <RNToast autoHide topOffset={80} visibilityTime={3000} config={toastConfig} />
}
