...
import { useCityToggleFavorite } from '@/domain/city/operations/useCityToggleFavorite'
import { TouchableOpacityBox } from './Box'
import { Icon } from './Icon'

export function CityFavoriteButton({ city, size }: { city: Pick<City, 'id' | 'isFavorite'>; size?: number }) {
