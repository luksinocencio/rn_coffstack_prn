...
type CityDetailsHeaderProps = Pick<City, 'id' | 'coverImage' | 'categories' | 'isFavorite'>

export function CityDetailsHeader({ id, coverImage, categories, isFavorite }: CityDetailsHeaderProps) {
